            ...
            function () {
                ...
                Table_createClass(Table, [{
                    ...
                    */
                    ...
                    key: "widthTable",
                    value: function widthTable(rng) {

                        var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
                        
                        showSummerNoteTableWidthModal($(cell).parent().parent().parent());

                        //external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(cell).closest('table').css({"width":"50px"});
                    }
                }]);
            ...
            function () {
                ...
                Editor_createClass(Editor, [{
                    ...
                    */
                    ...
                    key: "widthTable",
                    value: function widthTable() {
                        var rng = this.getLastRange(this.$editable);

                        if (rng.isCollapsed() && rng.isOnCell()) {
                            this.beforeCommand();
                            this.table.widthTable(rng);
                            this.afterCommand();
                        }
                    }
                    /**
            ...
            function () {
                ...
                Buttons_createClass(Buttons, [{
                    ...
                    value: function addTablePopoverButtons() {
                        ...
                        this.context.memo('button.widthTable', function () {
                            return _this5.button({
                                className: 'btn-md',
                                contents: _this5.ui.icon(_this5.options.icons.arrowsalth),
                                tooltip: _this5.lang.table.widthTable,
                                click: _this5.context.createInvokeHandler('editor.widthTable')
                            }).render();
                        });
                    }
                }, {
                            ...
                            $('#summerNoteUploadFile').on('change', function (e) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (url) {
                                        ...
                                        HoldOn.close();
                                        resetFileInput("summerNoteUploadFile");
                                    },
            ...
            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
                ...
                options: {
                    ...
                    popover: {
                        ...
                        table: [['add', ['addRowDown', 'addRowUp', 'addColLeft', 'addColRight']], ['delete', ['deleteRow', 'deleteCol', 'deleteTable', 'widthTable']]],
                    ...
                    icons: {
                        ...
                        'arrowsalth': 'fa fa-arrows-h',
                        'arrowsaltv': 'fa fa-arrows-v',
...
var cellObject = null;
function showSummerNoteTableWidthModal(cell)
{
    cellObject = cell;
    
    $("#summerNoteTableWidthInput").val($(cellObject).width());

    $("#summerNoteTableWidthModal").modal();

}
function summerNoteTableWidthInputChange(inputElement) {
   
    $(cellObject).css(
            {
                "width": $(inputElement).val() + 'px'
            }
            );
}
